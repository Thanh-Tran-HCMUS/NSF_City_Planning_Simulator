    ...
    public partial class HighlightEffect : MonoBehaviour {
        ...
        void CheckOcclusionAccurate(Camera cam) {
            ...
            if (!reuse) {
                ...
                int numOccluderHits = Physics.BoxCastNonAlloc(pos, bounds.extents * seeThroughOccluderThreshold, (camPos - pos).normalized, occluderHits, Quaternion.identity, maxDistance, seeThroughOccluderMask);
