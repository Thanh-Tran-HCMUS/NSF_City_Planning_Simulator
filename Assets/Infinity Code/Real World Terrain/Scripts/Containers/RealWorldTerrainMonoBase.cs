...
namespace InfinityCode.RealWorldTerrain
{
    ...
    public abstract class RealWorldTerrainMonoBase : MonoBehaviour
    {
        ...
        public void SetCoordinates(double x1, double y1, double x2, double y2)
        {
            ...
            RealWorldTerrainUtils.MercatToLatLong(leftMercator, topMercator, out leftLongitude, out topLatitude);
            RealWorldTerrainUtils.MercatToLatLong(rightMercator, bottomMercator, out rightLongitude, out bottomLatitude);
