...
namespace InfinityCode.RealWorldTerrain.Windows
{
    public class RealWorldTerrainHistoryWindow: EditorWindow
    {
        ...
        private static string historyPath
        {
            get
            {
                return System.IO.Path.Combine(RealWorldTerrainEditorUtils.historyCacheFolder, "hystory.xml");
            }
        }
        ...
        public static void Add(RealWorldTerrainPrefs prefs)
        {
            ...
            string path = System.IO.Path.Combine(RealWorldTerrainEditorUtils.historyCacheFolder, id + ".xml");
        ...
        private void OnGUI()
        {
            ...
            for (int i = recent.Count - 1; i >= 0; i--)
            {
                ...
                if (GUILayout.Button(useContent, GUILayout.Width(20)))
                {
                    ...
                    RealWorldTerrainWindow.prefs.LoadFromXML(System.IO.Path.Combine(RealWorldTerrainEditorUtils.historyCacheFolder, item.id + ".xml"));
                }
            ...
            if (removeIndex != -1)
            {
                ...
                string filaname = System.IO.Path.Combine(RealWorldTerrainEditorUtils.historyCacheFolder, item.id + ".xml");
