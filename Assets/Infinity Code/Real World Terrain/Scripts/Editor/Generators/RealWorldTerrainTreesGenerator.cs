    ...
    public static class RealWorldTerrainTreesGenerator
    {
        ...
        public static string url
        {
            get
            {
                ...
                string _url = string.Format(RealWorldTerrainCultureInfo.numberFormat, builder.ToString(), prefs.coordinatesTo.y, prefs.coordinatesFrom.x, prefs.coordinatesFrom.y, prefs.coordinatesTo.x);
        ...
        public static string filename
        {
            get
            {
                return System.IO.Path.Combine(RealWorldTerrainEditorUtils.osmCacheFolder, string.Format("trees_{0}_{1}_{2}_{3}.osm", prefs.coordinatesTo.y, prefs.coordinatesFrom.x, prefs.coordinatesFrom.y, prefs.coordinatesTo.x));
            }
        }
        ...
        public static void Generate(RealWorldTerrainContainer container)
        {
            ...
            double sx, sy, ex, ey;
            RealWorldTerrainUtils.LatLongToMercat(prefs.coordinatesFrom.x, prefs.coordinatesFrom.y, out sx, out sy);
            RealWorldTerrainUtils.LatLongToMercat(prefs.coordinatesTo.x, prefs.coordinatesTo.y, out ex, out ey);
