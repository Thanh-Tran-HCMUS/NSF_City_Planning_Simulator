...
namespace InfinityCode.RealWorldTerrain.Generators
{
    public static class RealWorldTerrainRiverGenerator
    {
        ...
        public static string url
        {
            get
            {
                string request = string.Format("node({0},{1},{2},{3});way(bn);rel(bw)['waterway'~'riverbank'];(._;>;);out;", prefs.coordinatesTo.y, prefs.coordinatesFrom.x, prefs.coordinatesFrom.y, prefs.coordinatesTo.x);
                Debug.Log(request);
        ...
        public static string filename
        {
            get
            {
                return System.IO.Path.Combine(RealWorldTerrainEditorUtils.osmCacheFolder, string.Format("rivers_{0}_{1}_{2}_{3}.osm", prefs.coordinatesTo.y, prefs.coordinatesFrom.x, prefs.coordinatesFrom.y, prefs.coordinatesTo.x));
            }
        }
