...
namespace InfinityCode.RealWorldTerrain.Generators
{
    public class RealWorldTerrainBingElevationGenerator : RealWorldTerrainElevationGenerator
    {
        ...
        private void Download()
        {
            ...
            for (int x = 0; x < s; x++)
            {
                ...
                for (int y = 0; y < s; y++)
                {
                    ...
                    string partFilename = System.IO.Path.Combine(bingFolder, string.Format(RealWorldTerrainCultureInfo.numberFormat, "bing_{0}x{1}x{2}x{3}x{4}.json", sx, sy, ex, ey, mapSize));
        ...
        public static void Init()
        {
            ...
            float sx = prefs.coordinatesFrom.x;
            float sy = prefs.coordinatesFrom.y;
            float ex = prefs.coordinatesTo.x;
            float ey = prefs.coordinatesTo.y;
            ...
            bingFolder = System.IO.Path.Combine(RealWorldTerrainEditorUtils.heightmapCacheFolder, "BingParts");
