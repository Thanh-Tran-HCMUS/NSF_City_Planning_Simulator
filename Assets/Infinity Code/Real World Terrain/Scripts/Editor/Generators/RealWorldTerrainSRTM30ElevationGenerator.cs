...
namespace InfinityCode.RealWorldTerrain.Generators
{
    public class RealWorldTerrainSRTM30ElevationGenerator : RealWorldTerrainElevationGenerator
    {
        ...
        public RealWorldTerrainSRTM30ElevationGenerator(int X, int Y, ref bool needAuth)
        {
            ...
            heightmapFilename = System.IO.Path.Combine(RealWorldTerrainEditorUtils.heightmapCacheFolder, filename);
        ...
        {
            int sx = Mathf.FloorToInt(prefs.coordinatesFrom.x + 180) - 180;
            int sy = Mathf.FloorToInt(prefs.coordinatesFrom.y + 90) - 90;
            int ex = Mathf.FloorToInt(prefs.coordinatesTo.x + 180) - 180;
            int ey = Mathf.FloorToInt(prefs.coordinatesTo.y + 90) - 90;
