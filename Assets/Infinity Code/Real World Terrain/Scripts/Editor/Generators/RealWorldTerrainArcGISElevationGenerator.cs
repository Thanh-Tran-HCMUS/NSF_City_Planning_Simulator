...
namespace InfinityCode.RealWorldTerrain.Generators
{
    public class RealWorldTerrainArcGISElevationGenerator : RealWorldTerrainElevationGenerator
    {
        ...
        private void Download()
        {
            ...
            for (int x = 0; x < s; x++)
            {
                ...
                for (int y = 0; y < s; y++)
                {
                    ...
                    string partFilename = System.IO.Path.Combine(arcGisFolder, 
                        string.Format(RealWorldTerrainCultureInfo.numberFormat, 
        ...
        public static void Init()
        {
            ...
            arcGisFolder = System.IO.Path.Combine(RealWorldTerrainEditorUtils.heightmapCacheFolder, "ArcGISParts");
