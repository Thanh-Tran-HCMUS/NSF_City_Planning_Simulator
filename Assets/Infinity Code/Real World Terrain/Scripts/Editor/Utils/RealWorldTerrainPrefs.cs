...
namespace InfinityCode.RealWorldTerrain
{
    public class RealWorldTerrainPrefs : RealWorldTerrainPrefsBase
    {
        ...
        public static RealWorldTerrainPrefs GetPrefs(RealWorldTerrainMonoBase item, bool isNew = false)
        {
            ...
            {
                coordinatesFrom = new Vector2((float)item.leftLongitude, (float)item.topLatitude),
                coordinatesTo = new Vector2((float)item.rightLongitude, (float)item.bottomLatitude),
        ...
        public void Save()
        {
            ...
            string coordsScript = "var Coords = {" + string.Format(RealWorldTerrainCultureInfo.numberFormat, "tlx: {0}, tly: {1}, brx: {2}, bry: {3}", coordinatesFrom.x.ToString(culture), coordinatesFrom.y.ToString(culture), coordinatesTo.x.ToString(culture), coordinatesTo.y.ToString(culture)) + "};";
